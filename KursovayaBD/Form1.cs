    ...
    public partial class Form1 : MaterialForm
    {
        ...
        private void materialRaisedButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                workbook.SaveAs("C:\\Users\\Vitalia\\Desktop\\reports\\xlsxtickets"+ timeStamp+".xlsx", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
        ...
        private void materialRaisedButton2_Click(object sender, EventArgs e)
        {
            Int32 unixTimestamp = (Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
            string timeStamp = unixTimestamp.ToString();
            TextWriter writer = new StreamWriter("C:\\Users\\Vitalia\\Desktop\\reports\\texttickets"+ timeStamp+".txt");
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                for (int j = 0; j < dataGridView1.Columns.Count; j++)
                {
